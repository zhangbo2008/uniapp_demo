...
<!-- 底部的tab用    用 tn-tabbar-->
				<view class="tn-text-center" style="margin-left:30rpx;">
					<!-- 绑定属性 都是冒号, 绑定触发都是@, 绑定事件都是on emit -->
					<!-- 这种第三方控件使用方法  查看api:
					 https://vue2.tuniaokj.com/components/tabs.html  -->
	...
	export default {
		...
		data() {
			return {
				...
				cardCur: 0,
				swiperList: [],
				current: 1,      //注意这里默认是1, 不是0. 我们默认的给的是推荐
				scrollList: [{
						name: '关注'
					},
					{
